...
import { Download, ChevronRight, Eye, AlertTriangle, CheckCircle } from 'lucide-react';
import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer } from 'recharts';
import jsPDF from 'jspdf';
import 'jspdf-autotable';

export default function NumerasiClient({ schoolId, schoolName, metrics, classes, chartData }) {
    ...
    <div className="animate-fade-in" style={{ paddingBottom: '40px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '32px' }}>
        <div style={{ flex: 1, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
          <div>
            <h1 style={{ fontSize: '2rem', color: '#111827', margin: 0, fontWeight: 700 }}>Pemantauan Numerasi</h1>
            <p style={{ color: '#4b5563', margin: '8px 0 0 0', fontSize: '1rem' }}>Ringkasan data numerasi siswa di {schoolName}.</p>
          </div>
          <button 
